...
https://github.com/tu-dortmund-ls12-rt/SSSEvaluation/blob/master/schedTest/WLAEDF.py"""
...
def Wnc(i, l, xil, slj, tasks):
    ...
    if i != l:
        ...
        val = min(math.floor(xil / tasks[l]['period']) * tasks[l]['execution'] - tasks[l]['execution'],
                  xil - tasks[l]['period'])
    return val
