...
https://github.com/tu-dortmund-ls12-rt/SSSEvaluation/blob/master/schedTest/tgPath.py"""
...
def taskGeneration_p(numTasks, uTotal, minsslength, maxsslength, Pmin=100, numLog=1, vRatio=1, numsegs=2, minSratio=1,
                     numpaths=2, scalef=0.8):
    init()
